...
export const connectionTypeRRVData = [
	{
		...
		valveTypeData: {
			...
			valveValue: '31',
			valvePrice: 127.62,
			valveDescription: 'со встроенным вентилем справа вверху (M30x1,5)',
			valveText: "Стандарнтный вентиль с подключением справа вверху (M30x1,5)",
		},
		defaultChecked: true
	},
	{
		...
		valveTypeData: {
			...
			valveValue: '31',
			valvePrice: 127.62,
			valveDescription: 'со встроенным вентилем слева вверху (M30x1,5)',
			valveText: "Стандарнтный вентиль с подключением слева вверху (M30x1,5)",
		}
	},
	{
		name: 'connectionType',
	...
	},
	{
		...
		valveTypeData: {
			...
			valveValue: '61',
			valvePrice: 179.34,
			valveDescription: 'со встроенным вентилем справа внизу (M30x1,5)',
			valveText: "Стандарнтный вентиль с подключением справа внизу (M30x1,5)",
		}
	},
	{
		name: 'connectionType',
		...
		valveTypeData: {
			...
			valveValue: '61',
			valvePrice: 179.34,
			valveDescription: 'со встроенным вентилем слева внизу (M30x1,5)',
			valveText: "Стандарнтный вентиль с подключением слева внизу (M30x1,5)",
		}
	},
	{
		name: 'connectionType',
		...
		valveTypeData: {
			...
			valvePrice: 179.34,
			valveDescription: 'со встроенным вентилем справа внизу (M30x1,5)',
			valveText: "Стандарнтный вентиль с подключением спраа внизу (M30x1,5)",
		}
	},
	{
		name: 'connectionType',
